...
for n = 1 : length(dinfo)
    ...
    lr = str2double(append("0.", erase(fileName, ["Crack", ".log", "First", "Second", "Third"])));
...
xtickangle(45);
xlabel('LR') 
title('Crack 500 F1 Loss Variance');
...
xtickangle(45);
xlabel('LR') 
title('Crack 500 Jaccard Variance');
...
xtickangle(45);
xlabel('LR') 
title('Crack 500 Precision Mean');
...
xtickangle(45);
xlabel('LR') 
title('Crack 500 Precision Variance');
...
xtickangle(45);
xlabel('LR') 
title('Crack 500 Recall Variance');
